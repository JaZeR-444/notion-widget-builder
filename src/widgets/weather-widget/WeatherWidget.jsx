...
const WeatherIcon = ({ condition, animate, greyscale, size = 32 }) => {
  const iconProps = {
    ...
    style: { color: greyscale ? theme.colors.softSlate : theme.colors.sunburstGold },
    'aria-hidden': true
  };
  ...
  const conditionMap = {
    'sunny': <Sun {...iconProps} />,
    'clear': <Sun {...iconProps} />,
    'rainy': <CloudRain {...iconProps} style={{ ...iconProps.style, color: theme.colors.cosmicBlue }} />,
    'rain': <CloudRain {...iconProps} style={{ ...iconProps.style, color: theme.colors.cosmicBlue }} />,
    'drizzle': <CloudDrizzle {...iconProps} style={{ ...iconProps.style, color: theme.colors.aetherTeal }} />,
    'cloudy': <Cloud {...iconProps} style={{ ...iconProps.style, color: theme.colors.softSlate }} />,
    'clouds': <Cloud {...iconProps} style={{ ...iconProps.style, color: theme.colors.softSlate }} />,
    'partly-cloudy': <CloudSun {...iconProps} style={{ ...iconProps.style, color: theme.colors.aetherTeal }} />,
    'snow': <CloudSnow {...iconProps} style={{ ...iconProps.style, color: theme.colors.stardustWhite }} />,
    'thunderstorm': <CloudLightning {...iconProps} style={{ ...iconProps.style, color: theme.colors.electricPurple }} />,
    'mist': <CloudFog {...iconProps} style={{ ...iconProps.style, color: theme.colors.softSlate }} />,
    'fog': <CloudFog {...iconProps} style={{ ...iconProps.style, color: theme.colors.softSlate }} />,
    'haze': <CloudFog {...iconProps} style={{ ...iconProps.style, color: theme.colors.softSlate }} />,
    'smoke': <CloudFog {...iconProps} style={{ ...iconProps.style, color: theme.colors.graphite }} />,
    'dust': <Wind {...iconProps} style={{ ...iconProps.style, color: theme.colors.sunburstGold }} />,
    'sand': <Wind {...iconProps} style={{ ...iconProps.style, color: theme.colors.sunburstGold }} />,
    'tornado': <Wind {...iconProps} style={{ ...iconProps.style, color: theme.colors.electricPurple }} />
  };
  ...
  return (
    <span role="img" aria-label={ariaLabel}>
      {conditionMap[displayCondition] || <CloudSun {...iconProps} style={{ ...iconProps.style, color: theme.colors.aetherTeal }} />}
    </span>
  );
};
